...
**프로젝트 허브, 데일리 노트, 작업 보드, 주기 노트, 웹 리소스를 하나의 뷰에 통합하세요.**
...
볼트가 커질수록:
- 데일리 노트, 프로젝트 허브, 작업 보드를 만들었지만 막상 열려면 **검색하고 클릭하고 전환**하는 반복이 필요합니다
- 중요한 노트들이 볼트 깊숙이 흩어져 있고, **필요한 순간에 바로 접근**하기 어렵습니다
- 오늘의 할 일이 데일리 노트에 있는데, **매번 캘린더를 뒤지거나 검색**해야 합니다
- 자주 쓰는 노트들을 북마크해도, **여전히 사이드바를 열고 스크롤**해야 합니다

---

## Synaptic View가 해결합니다

**Synaptic View**는 당신의 볼트를 **하나의 통합된 컨트롤 센터**로 만들어줍니다.

Synaptic View를 열면:
- **필요한 모든 곳으로 한 번에 이동**할 수 있는 큼직한 버튼들이 상단에 나타납니다
- 데일리 노트, 프로젝트 허브, 작업 리스트, 웹 리소스까지 **한 곳에서 관리**합니다
- **캘린더 UI**로 과거/미래의 노트를 자유롭게 탐색합니다
- 오늘의 할 일 개수를 **실시간으로 확인**할 수 있습니다

**사용 방법**:
- 커맨드 팔레트에서 `Open Synaptic View tab`으로 원할 때 열거나
- **새 탭을 Synaptic View로 대체**하여 항상 바로 접근할 수 있습니다

시냅스처럼 빠르고 자연스러운 연결. 이제 당신의 "두 번째 뇌"를 **진짜 컨트롤**할 수 있습니다.
